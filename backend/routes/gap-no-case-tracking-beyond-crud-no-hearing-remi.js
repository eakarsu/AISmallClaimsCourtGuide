...
const FEATURE_SLUG = 'no-case-tracking-beyond-crud-no-hearing-remi';
const FEATURE_TITLE = 'No case tracking beyond CRUD (no hearing reminders)';
const PROJECT = 'AISmallClaimsCourtGuide';
