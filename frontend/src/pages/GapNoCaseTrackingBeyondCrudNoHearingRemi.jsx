...
export default function GapNoCaseTrackingBeyondCrudNoHearingRemi() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-case-tracking-beyond-crud-no-hearing-remi', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No case tracking beyond CRUD (no hearing reminders)</h1>
      <p style={{ color: '#666', marginBottom: 16 }}>AISmallClaimsCourtGuide - Gap feature</p>
